...
const HelpAndSupport = () => {
  var [action, setaction] = useState("FAQ");
  ...
  const FAQcomponent = () => {
    const qustions = [
      {
        qfirst: "How can i track my parcel ",
        ans: " You can track your parcel with the help of your parcel traking id",
      },
      {
        qfirst: "What can i do if my parcel is Delayed ",
        ans: " Fill Contact  Form we will contact you",
      },
    ];

    return (
      <div className="faqqustion">
        {qustions.map((q) => (
          <div key={q.qfirst}>
            <h3>{q.qfirst}</h3>
            <p>{q.ans}</p>
      ...
      return(
        <div className="contactForm">
            <form className="cform">
                <label className="cformlabel">Name</label>
                <input className="cforminput" type="text"/>
                <label className="cformlabel">Email</label>
                <input className="cforminput" type="email"/>
                <label className="cformlabel">Query</label>
                <textarea className="cformtextarea"></textarea>
                <button className="contactfbtn">Submit</button>
            </form>
        </div>
      )
  };
  ...
  return (
    <div className=".row allh">
    <div className="margethis">

    <button className="hsbtn1" onClick={() => setaction("FAQ")}>FAQ</button>
    <button className="hsbtn2" onClick={()=>setaction("contactus")}>Contact Us</button>
    <button className="hsbtn3" onClick={()=>setaction("feedback")}>FeedBack</button>
    <hr/>
    {action === "FAQ" && <FAQcomponent />}
  {action==="contactus" &&<ContactSupport/>}
  {action==="feedback" && <FeedBack/>}</div>
